...
var _excluded = ["range", "value", "eachInputDropdown", "manuallyDisplayDropdown", "setValue", "moveNext", "allowDelete", "toggleAmPm", "className", "fullTimeDropdown", "inputRef", "movePrev", "inputFocused", "setInputFocused", "setSafeValue", "onMoveNext", "amPm"];
...
var InputTimeHelper = props => {
  ...
  var setSafeValue = useCallback((value, other) => {
